 ...
 */
public class PrefActivity extends BasePreferenceActivity {
    ...
    private La365PrefFragment fragment_;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // La365PrefFragment をトップレベルで読み込む
        fragment_ = new La365PrefFragment();
        getFragmentManager().beginTransaction()
                .replace(android.R.id.content, fragment_).commit();
...
//    }
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || La365PrefFragment.class.getName().equals(fragmentName);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class La365PrefFragment extends PreferenceFragment {
        @Override
